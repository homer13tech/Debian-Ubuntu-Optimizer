...
#  v.1.4       May 17, 2022      Added Lazarus, FileZilla CLient, and Opera
#
#
#################################################################################################
...
mainmenu() 
{
   ...
   echo -ne "
     ...
     3c) Install All Terminals		4c) Python 2				5c) Chromium			6c) Install All App Stores/Repositories
		       			4d) Python3				5d) Brave
		       		        4e) GitHub Desktop			5e) Opera
    				        4f) CURL				5f) Install All Browsers
    				        4g) emacs
    				        4h) Lazarus
     					4i) Install All Development Apps
     					
     $(greenprint 'Office Suites')			$(greenprint 'Email/Chat Clients')     			$(greenprint 'Photography')			$(greenprint 'Audio')
     7a) Libre Office			8a) Thunderbird				9a) GIMP			10a) Audacity
     ...
     $(greenprint 'Video')   				$(greenprint 'Utilities')				$(greenprint 'Customization')			$(greenprint 'File Management')
     11a) VLC Player			12a) Neofetch				13a) Gnome Tweaks		14a) FileZilla CLient
     										13b) Conky
     										13c) Conky Manager
     										13d) All Customization Tools
     							
     										
     
     $(greenprint 'Install Entire Catalog')     
     15) Install All Applications Listed Above    
     
     $(blueprint 'Advanced Menu')
     $(greenprint 'Networking Tools')              	$(greenprint 'Penetration Testing Tools')
     16a) Wireshark                     17) Penetration Tools Menu
     16b) NMAP
     16c) Install All Network Tools
...
install_emacs()
{
   clear
   echo "***************************"
   echo "Starting emacs Installation"
   echo "***************************"
   sudo apt-get install emacs -y
   clear
   echo "****************************"
   echo "emacs Installation Completed"
   echo "****************************"
   sleep 5
   clear
}
install_gnome_tweaks()
{
   clear
   echo "**********************************"
   echo "Starting Gnome Tweaks Installation"
   echo "**********************************"
...
install_conky()
{
   clear
   echo "***************************"
   echo "Starting Conky Installation"
   echo "***************************"
   sudo apt-get install conky-all -y
   clear
   echo "****************************"
   echo "Conky Installation Completed"
   echo "****************************"
   sleep 5
   clear
}
install_conky_manager()
{
   clear
   echo "***********************************"
   echo "Starting Conky Manager Installation"
   echo "***********************************"
   ...
   clear
   echo "************************************"
   echo "Conky Manager Installation Completed"
   echo "************************************"
   sleep 5
   clear
}
install_opera()
{
   clear
   echo "***************************"
   echo "Starting Opera Installation"
   echo "***************************"
   snap install opera
   clear
   echo "****************************"
   echo "Opera Installation Completed"
   echo "****************************"
   sleep 5
   clear
}
install_lazarus()
{
   clear
   echo "*****************************"
   echo "Starting Lazarus Installation"
   echo "*****************************"
   sudo apt install lazarus -y
   clear
   echo "******************************"
   echo "Lazarus Installation Completed"
   echo "******************************"
   sleep 5
   clear
}
install_filezilla_client()
{
   clear
   echo "**************************************"
   echo "Starting FileZilla Client Installation"
   echo "**************************************"
   sudo apt install filezilla -y
   clear
   echo "***************************************"
   echo "FileZilla Client Installation Completed"
   echo "***************************************"
   sleep 5
   clear
}
