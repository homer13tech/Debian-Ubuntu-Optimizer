...
mainmenu() 
{
    ...
    echo -ne "
     ...
     $(greenprint 'Office Suites')			$(greenprint 'Email/Chat Clients')     
     7a) Libre Office			8a) Thunderbird
     7b) WPS Office			8b) Pidgin
     					8c) Slack
     					8d) Discord
     					8e) Skype
     					8f) Install All Email/Chat Clients
     
     $(greenprint 'Photography')			$(greenprint 'Audio')					$(greenprint 'Video')   
     9a) GIMP				10a) Audacity				11a) VLC Player
     9b) Blender								
     9c) Install All Photo Apps							
     										
     
     $(greenprint 'Install Entire Catalog')     
     12) Install All Applications Listed Above    
     
     $(blueprint 'Advanced Menu')
     $(greenprint 'Networking Tools')              	$(greenprint 'Penetration Testing Tools')
     13a) Wireshark                     14) Penetration Tools Menu
     13b) NMAP
     13c) Install All Network Tools
