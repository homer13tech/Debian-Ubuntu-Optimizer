...
#  v.1.3       May 13, 2022      dded Customization Subsection and tools under it, aligned code
#
#
#
#################################################################################################
   ...
   echo -ne "
     ...
     3c) Install All Terminals		4c) Python 2				5c) Chromium			6c) Install All App Stores/Repositories
		       			4d) Python3				5d) Brave
    				        ...
    				        4f) CURL
    				        4g) emacs
    				        4h) Install All Development Apps
     ...
     $(greenprint 'Video')   				$(greenprint 'Utilities')				$(greenprint 'Customization')
     11a) VLC Player			12a) Neofetch				13a) Gnome Tweaks
     										13b) Conky
     										13c) Conky Manager
     ...
     14) Install All Applications Listed Above    
     
     $(blueprint 'Advanced Menu')
     $(greenprint 'Networking Tools')              	$(greenprint 'Penetration Testing Tools')
     15a) Wireshark                     16) Penetration Tools Menu
     15b) NMAP
     15c) Install All Network Tools
